      ...
      <div className="container mx-auto h-full px-4 sm:px-6 md:px-8">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between lg:pt-8 lg:pb-24">
          ...
          <div className="w-full lg:w-2/3 text-center lg:text-left">
            <span className="inline-block text-lg text-sky-600 dark:text-sky-300 font-medium">
              Software Developer
            </span>

            <HeroTyping
              strings={[
                "Xin chào — Tôi là Minh Thoại",
                "Tôi là Full-stack developer",
              ]}
              typingSpeed={70}
              deletingSpeed={35}
              pause={1300}
            ...
            <p className="mt-4 max-w-2xl text-slate-700 dark:text-slate-300">
              Tôi xây dựng các ứng dụng web tinh gọn, nhanh và dễ mở rộng. Tập
              trung vào code sạch, trải nghiệm người dùng mượt mà và hiệu suất
              thực tế.
            </p>
          ...
          <div className="w-full lg:w-1/3 flex justify-center lg:justify-end mb-8 lg:mb-0">
            <AvatarFrame
              ...
              alt="Minh Thoai"
              size={220}
              gradientClass="from-sky-400 via-teal-400 to-rose-400"
              spinDuration={6}
